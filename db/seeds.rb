...
#Preconditions
@lo= LearningObjective.where(:knowledge_element_id => @ke1.id, :cognitiveDimension => 3).first
...
### Grett, ottinger ###
#Subexercise
Subexercise.create(:position => 1, :text => "y= 2x + 1", :solution_id =>1, :exercise_id => 1, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 1)
Subexercise.create(:position => 1, :text => "y = x - 1", :solution_id => 2, :exercise_id => 1, :points => 2, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 2)
Subexercise.create(:position => 1, :text => "Die Gerade verläuft durch den Punkt A(2/3) und m=2", :exercise_id => 2, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 3)
Subexercise.create(:position => 1, :text => "Die Gerade verläuft durch die Punkte A(1/6) und B(-3/1)", :exercise_id => 2, :points => 4, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 1)
Subexercise.create(:position => 1, :text => "y-Achsenabschnitt", :exercise_id => 3, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 1, :users_id => 2)
Subexercise.create(:position => 1, :text => "Steigung", :exercise_id => 3, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 1, :users_id => 3)
Subexercise.create(:position => 1, :text => "Geg.: A(0/3), B(4/6). Vorgehen: 6=m4 + t => t=6/4m => 6=m4 + 6/4m ...", :exercise_id => 10, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 5, :users_id => 1)
Subexercise.create(:position => 1, :text => "Nenner", :exercise_id => 4, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 1, :users_id => 2)
Subexercise.create(:position => 1, :text => "Zähler", :exercise_id => 4, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 1, :users_id => 3)
Subexercise.create(:position => 1, :text => "1/2 + 3/4", :exercise_id => 5, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 1)
Subexercise.create(:position => 1, :text => "5/3 - 7/8", :exercise_id => 5, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 2)
Subexercise.create(:position => 1, :text => "3/5 : 4/3", :exercise_id => 5, :points => 1, :moderated => FALSE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 3)
Subexercise.create(:position => 1, :text => "6/9", :exercise_id => 6, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 1)
Subexercise.create(:position => 1, :text => "5/10", :exercise_id => 6, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 2)
Subexercise.create(:position => 1, :text => "Rationale Zahlen", :exercise_id => 8, :points => 1, :moderated => FALSE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 1, :users_id => 3)
Subexercise.create(:position => 1, :text => "3/4  1/2  5/6  ", :exercise_id => 9, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 3, :users_id => 1)
Subexercise.create(:position => 1, :text => "Für dein neues Smartphone zahlst du zunächst nur die Hälfte, muss dann aber ein Jahr lang jeden Monat 1/10 vom Kaufpreis zahlen.", :exercise_id => 7, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 5, :users_id => 2)
Subexercise.create(:position => 1, :text => "Paula bezahlt 20% mehr für ihr Smartphone als Toni, ihr Vertrag kostet jedoch 10% weniger als Tonis. ", :exercise_id => 7, :points => 1, :moderated => TRUE, :active => TRUE, :examItem => TRUE, :cognitive_dimension => 5, :users_id => 3)
