...
### Arndt-Olwitz ###
#User
User.create(:username => "admin", :email => "admin@mls.de", :firstname => "Learner", :lastname => "Test", :birthday => Date.new(1990,1,1), :password => "Password123!", :admin => TRUE)
...
User.create(:username => "learner", :email => "learner@mls.de", :firstname => "Admin", :lastname => "Test", :birthday => Date.new(2000,1,1), :password => "Password123!", :learner => TRUE, :pupil => TRUE)
