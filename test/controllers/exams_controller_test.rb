...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { maxPoints: @exam.maxPoints, maxTime: @exam.maxTime, minPoints: @exam.minPoints }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { maxPoints: @exam.maxPoints, maxTime: @exam.maxTime, minPoints: @exam.minPoints }
    assert_redirected_to exam_path(assigns(:exam))
  end
